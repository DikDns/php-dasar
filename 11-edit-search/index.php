...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-3">
            ...
            <div class="col-md-12">
                <form action="" method="POST">
                    <div class="input-group">
                        <input type="text" class="form-control fs-5" placeholder="Search Keyword" aria-label="Search Keyword" aria-describedby="search" name="keyword" autocomplete="off">
                        <button class="btn btn-outline-primary fs-5" type="submit" id="search" name="search">Search</button>
                    </div>
                </form>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
                <a class="text-center w-100 fs-5 btn-menu btn btn-outline-secondary" href="insert.php" role="button">Insert Data</a>
            </div>
        </div>
        <div class="row mb-3">
