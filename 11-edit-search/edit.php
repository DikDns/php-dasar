...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-4 mb-4">
        <div class="row mb-2">
            <div class="col">
                <a class="w-100 fs-5 btn-menu btn btn-outline-secondary" href="index.php" id="back-btn" role="button">Back</a>
            </div>
        </div>
        <div class="row">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $videogame["year"]?>" required type="text" pattern="\d*" class="form-control form-control-sm" id="year" name="year" aria-describedby="yearHelp">
                ...
                <div class="mb-3">
                    ...
                    <input value="<?= $videogame["image"]?>" required type="text" class="form-control form-control-sm" id="image" name="image">
                </div>

                <button type="submit" class="w-100 fs-5 btn btn-primary" name="submit">Save Changes</button>
            </form>
        </div>
    </div>
