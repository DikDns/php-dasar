        ...
        <div class="row">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input required type="text" pattern="\d\d\d\d" class="form-control form-control-sm" id="year" name="year" title="Example: 2022">
                </div>
                ...
                <button type="submit" class="mt-4 w-100 fs-5 btn btn-primary" name="submit">Submit</button>
            </form>
        </div>
    </div>
